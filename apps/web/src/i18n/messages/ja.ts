...
export const ja: LocaleMessages = {
  ...
  "reputation.title": "村の評判",
  "reputation.points": "{points} 評判ポイント",
  "reputation.tier.hamlet": "集落",
  "reputation.tier.village": "村",
  "reputation.tier.town": "町",
  "reputation.tier.city": "都市",
  "reputation.tier.metropolis": "大都市",
  "reputation.progress": "次のランクまで: {percent}%",
  "reputation.tierUp": "村が{tier}に成長しました！",
  "reputation.contribute": "村に貢献する",
  "reputation.project.village_well.name": "村の井戸",
  "reputation.project.village_well.description":
    "全住民にきれいな水を供給する中央井戸を建設します。",
  "reputation.project.village_well.unlock": "水の庭園エリアが解放されます。",
  "reputation.project.town_market.name": "町の市場",
  "reputation.project.town_market.description":
    "にぎやかな市場を建設して交易を始めます。",
  "reputation.project.town_market.unlock": "拡張された店舗品揃えが解放されます。",
  "reputation.project.city_library.name": "都市図書館",
  "reputation.project.city_library.description": "知識を保存する大図書館を建設します。",
  "reputation.project.city_library.unlock": "上級クイズのテーマが解放されます。",
  "reputation.project.metropolis_plaza.name": "大都市広場",
  "reputation.project.metropolis_plaza.description":
    "集まりのための壮大な中央広場を作ります。",
  "reputation.project.metropolis_plaza.unlock": "大祭典会場が解放されます。",
  "reputation.project.grand_monument.name": "大記念碑",
  "reputation.project.grand_monument.description":
    "コミュニティの功績を称える記念碑を建てます。",
  "reputation.project.grand_monument.unlock": "記念碑公園エリアが解放されます。",
  "reputation.reward": "ランク報酬: {coins} コイン！",
  "reputation.milestone": "新しいマイルストーンに到達しました！",
  "reputation.benefits.hamlet": "集落としての慎ましい始まりです。",
  "reputation.benefits.village": "基本的な村のサービスと共同井戸があります。",
  "reputation.benefits.town": "市場と交易路のある栄える町です。",
  "reputation.benefits.city": "図書館と文化行事のある繁栄する都市です。",
  "reputation.benefits.metropolis": "広場、記念碑、祭典のある壮大な大都市です。",
  "achievement.first_contributor.title": "初めての貢献者",
  "achievement.first_contributor.description": "村に初めての貢献をしよう。",
  "achievement.village_builder.title": "村の建設者",
  "achievement.village_builder.description": "集落を村ランクに成長させよう。",
  "achievement.community_leader.title": "コミュニティリーダー",
  "achievement.community_leader.description": "コミュニティを町ランクに導こう。",
};
