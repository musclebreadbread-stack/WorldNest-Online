...
export const pt: LocaleMessages = {
  ...
  "friendship.title": "Amizade",
  "friendship.level.0": "Desconhecido",
  "friendship.level.1": "Conhecido",
  "friendship.level.2": "Amigo",
  "friendship.level.3": "Amigo proximo",
  "friendship.level.4": "Melhor amigo",
  "friendship.give": "Dar presente",
  "friendship.reaction.loved": "Adorou!",
  "friendship.reaction.liked": "Gostou!",
  "friendship.reaction.neutral": "Obrigado pelo presente.",
  "friendship.reaction.disliked": "Nao e bem o gosto dele...",
  "friendship.levelUp": "Nivel de amizade subiu!",
  "friendship.maxLevel": "Amizade maxima alcancada!",
  "friendship.dailyLimit": "Ja deu um presente hoje.",
  "friendship.reward": "Recebeu {coins} moedas!",
  "item.gift_box": "Caixa de presente",
  "achievement.first_gift.title": "Primeiro presente",
  ...
  "mission.title": "Missoes",
  "mission.daily": "Missao diaria",
  "mission.weekly": "Missao semanal",
  "mission.streak": "Sequencia: {days} dias",
  "mission.streakBonus": "Bonus de sequencia: x{multiplier}",
  "mission.complete": "Missao concluida!",
  "mission.claim": "Receber recompensa",
  "mission.refresh": "Novas missoes disponiveis!",
  "mission.progress": "{current} / {target}",
  "mission.daily_gather_wood.title": "Coletar lenha",
  "mission.daily_gather_wood.description": "Colete 5 madeiras da floresta.",
  "mission.daily_gather_stone.title": "Coletar pedras",
  "mission.daily_gather_stone.description": "Colete 3 pedras das colinas.",
  "mission.daily_fish.title": "Ir pescar",
  "mission.daily_fish.description": "Pesque 2 peixes em qualquer corpo d'agua.",
  "mission.daily_donate.title": "Ajudante do museu",
  "mission.daily_donate.description": "Doe 1 item ao museu.",
  "mission.daily_cook.title": "Ajudante de cozinha",
  "mission.daily_cook.description": "Cozinhe 1 prato na cozinha.",
  "mission.daily_explore.title": "Andarilho",
  "mission.daily_explore.description": "Explore 10 novas celulas do mapa.",
  "mission.daily_talk.title": "Borboleta social",
  "mission.daily_talk.description": "Converse com 2 NPCs diferentes.",
  "mission.daily_harvest_wheat.title": "Colheita de trigo",
  "mission.daily_harvest_wheat.description": "Colha 3 trigos da sua fazenda.",
  "mission.weekly_fish_master.title": "Mestre pescador",
  "mission.weekly_fish_master.description": "Pesque 10 peixes esta semana.",
  "mission.weekly_explorer.title": "Cartografo",
  "mission.weekly_explorer.description": "Explore 50 celulas do mapa esta semana.",
  "mission.weekly_cook_feast.title": "Preparador de banquete",
  "mission.weekly_cook_feast.description": "Cozinhe 5 pratos esta semana.",
  "mission.weekly_social.title": "Sociavel da vila",
  "mission.weekly_social.description": "Converse com NPCs 8 vezes esta semana.",
  "achievement.first_mission.title": "Primeira missao",
  "achievement.first_mission.description": "Complete sua primeira missao.",
  ...
  "npc.flora.name": "Flora a Jardineira",
  "npc.activity.gardening": "Jardinagem",
  "dialogue.flora.greeting":
    "Ola, amante de flores! Meu jardim esta sempre florido. Quer plantar flores ou participar de um concurso?",
  "dialogue.flora.planting":
    "Plante uma flor no seu canteiro, regue regularmente e colha quando florescer!",
  "dialogue.flora.competition":
    "Monte um buque com suas melhores flores e participe do meu concurso. Os juizes dao bronze, prata ou ouro!",
  "dialogue.flora.option.plant": "Fale sobre plantar",
  "dialogue.flora.option.compete": "Participar do concurso",

  "item.rose": "Rosa",
  "item.lily": "Lirio",
  "item.tulip": "Tulipa",
  "item.sunflower": "Girassol",
  "item.garden_plot": "Canteiro",
  "item.flower_arrangement": "Arranjo Floral",

  "gardening.title": "Jardim",
  "gardening.plant": "Plantar flor",
  "gardening.water": "Regar jardim",
  "gardening.arrange": "Criar arranjo",
  "gardening.compete": "Participar do concurso",
  "gardening.score": "Pontuacao de beleza: {score}",
  "gardening.competition.enter": "Participando do concurso...",
  "gardening.competition.bronze": "Bronze! Voce ganhou {coins} moedas.",
  "gardening.competition.silver": "Prata! Voce ganhou {coins} moedas.",
  "gardening.competition.gold": "Ouro! Voce ganhou {coins} moedas.",

  "achievement.first_arrangement.title": "Primeiro Buque",
  "achievement.first_arrangement.description": "Crie seu primeiro arranjo floral.",
  "achievement.garden_master.title": "Mestre Jardineiro",
  "achievement.garden_master.description": "Crie 5 arranjos florais.",
