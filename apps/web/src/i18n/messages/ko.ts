...
export const ko: LocaleMessages = {
  ...
  "transport.board": "배 탑승",
  "transport.disembark": "하선",
  "transport.exhausted": "탈것이 지쳤습니다!",
  "transport.feed": "탈것에게 먹이주기",
  "transport.bond": "유대 레벨: {level}",
  "transport.noStamina": "체력이 부족합니다",
  "item.mount_saddle": "안장",
  "item.boat": "보트",
  "item.horse_whistle": "말 호루라기",
  "item.donkey_whistle": "당나귀 호루라기",
  "item.camel_whistle": "낙타 호루라기",
  "achievement.first_ride.title": "첫 번째 탑승",
  "achievement.first_ride.description": "처음으로 동물에 탑승하세요.",
  "achievement.sea_explorer.title": "바다 탐험가",
  "achievement.sea_explorer.description": "배로 물 타일 100개를 이동하세요.",

  "friendship.title": "우정",
  "friendship.level.0": "낯선 사람",
  "friendship.level.1": "지인",
  "friendship.level.2": "친구",
  "friendship.level.3": "가까운 친구",
  "friendship.level.4": "절친",
  "friendship.give": "선물 주기",
  "friendship.reaction.loved": "정말 좋아해요!",
  "friendship.reaction.liked": "마음에 들어해요!",
  "friendship.reaction.neutral": "선물 고마워요.",
  "friendship.reaction.disliked": "별로 좋아하지 않네요...",
  "friendship.levelUp": "우정 레벨 업!",
  "friendship.maxLevel": "최고 우정에 도달했습니다!",
  "friendship.dailyLimit": "오늘 이미 선물을 줬습니다.",
  "friendship.reward": "{coins} 코인을 받았습니다!",
  "item.gift_box": "선물 상자",
  "achievement.first_gift.title": "첫 선물",
  ...
  "mission.title": "임무",
  "mission.daily": "일일 임무",
  "mission.weekly": "주간 임무",
  "mission.streak": "연속: {days}일",
  "mission.streakBonus": "연속 보너스: x{multiplier}",
  "mission.complete": "임무 완료!",
  "mission.claim": "보상 받기",
  "mission.refresh": "새로운 임무가 있습니다!",
  "mission.progress": "{current} / {target}",
  "mission.daily_gather_wood.title": "장작 모으기",
  "mission.daily_gather_wood.description": "숲에서 나무 5개를 모으세요.",
  "mission.daily_gather_stone.title": "돌 수집",
  "mission.daily_gather_stone.description": "언덕에서 돌 3개를 모으세요.",
  "mission.daily_fish.title": "낚시 가기",
  "mission.daily_fish.description": "물가에서 물고기 2마리를 잡으세요.",
  "mission.daily_donate.title": "박물관 도우미",
  "mission.daily_donate.description": "박물관에 아이템 1개를 기증하세요.",
  "mission.daily_cook.title": "요리 도우미",
  "mission.daily_cook.description": "주방에서 요리 1개를 만드세요.",
  "mission.daily_explore.title": "방랑자",
  "mission.daily_explore.description": "새로운 지도 타일 10개를 탐험하세요.",
  "mission.daily_talk.title": "사교가",
  "mission.daily_talk.description": "NPC 2명과 대화하세요.",
  "mission.daily_harvest_wheat.title": "밀 수확",
  "mission.daily_harvest_wheat.description": "농장에서 밀 3개를 수확하세요.",
  "mission.weekly_fish_master.title": "낚시 달인",
  "mission.weekly_fish_master.description": "이번 주에 물고기 10마리를 잡으세요.",
  "mission.weekly_explorer.title": "지도 제작자",
  "mission.weekly_explorer.description": "이번 주에 지도 타일 50개를 탐험하세요.",
  "mission.weekly_cook_feast.title": "잔치 준비",
  "mission.weekly_cook_feast.description": "이번 주에 요리 5개를 만드세요.",
  "mission.weekly_social.title": "마을 사교인",
  "mission.weekly_social.description": "이번 주에 NPC와 8번 대화하세요.",
  "achievement.first_mission.title": "첫 임무",
  ...
  "reputation.title": "마을 평판",
  "reputation.points": "{points} 평판 포인트",
  "reputation.tier.hamlet": "작은 마을",
  "reputation.tier.village": "마을",
  "reputation.tier.town": "읍",
  "reputation.tier.city": "도시",
  "reputation.tier.metropolis": "대도시",
  "reputation.progress": "다음 등급까지: {percent}%",
  "reputation.tierUp": "마을이 {tier}(으)로 성장했습니다!",
  "reputation.contribute": "마을에 기여하기",
  "reputation.project.village_well.name": "마을 우물",
  "reputation.project.village_well.description":
    "주민 모두에게 깨끗한 물을 공급할 중앙 우물을 건설합니다.",
  "reputation.project.village_well.unlock": "물의 정원 구역이 해금됩니다.",
  "reputation.project.town_market.name": "읍내 시장",
  "reputation.project.town_market.description":
    "활기찬 교역소를 건설하여 물물교환합니다.",
  "reputation.project.town_market.unlock": "확장된 상점 재고가 해금됩니다.",
  "reputation.project.city_library.name": "도시 도서관",
  "reputation.project.city_library.description": "지식을 보존할 대도서관을 건립합니다.",
  "reputation.project.city_library.unlock": "고급 퀴즈 주제가 해금됩니다.",
  "reputation.project.metropolis_plaza.name": "대도시 광장",
  "reputation.project.metropolis_plaza.description":
    "모임을 위한 웅장한 중앙 광장을 만듭니다.",
  "reputation.project.metropolis_plaza.unlock": "대축제 부지가 해금됩니다.",
  "reputation.project.grand_monument.name": "대기념비",
  "reputation.project.grand_monument.description":
    "커뮤니티의 업적을 기념하는 기념비를 세웁니다.",
  "reputation.project.grand_monument.unlock": "기념비 공원 구역이 해금됩니다.",
  "reputation.reward": "등급 보상: {coins} 코인!",
  "reputation.milestone": "새로운 이정표에 도달했습니다!",
  "reputation.benefits.hamlet": "정착지의 소박한 시작입니다.",
  "reputation.benefits.village": "기본 마을 서비스와 공동 우물이 있습니다.",
  "reputation.benefits.town": "시장과 교역로가 있는 번영하는 읍입니다.",
  "reputation.benefits.city": "도서관과 문화 행사가 있는 번화한 도시입니다.",
  "reputation.benefits.metropolis": "광장, 기념비, 축제가 있는 웅장한 대도시입니다.",
  "achievement.first_contributor.title": "첫 기여자",
  "achievement.first_contributor.description": "마을에 첫 기여를 하세요.",
  "achievement.village_builder.title": "마을 건설자",
  "achievement.village_builder.description": "정착지를 마을 등급으로 성장시키세요.",
  "achievement.community_leader.title": "커뮤니티 리더",
  "achievement.community_leader.description": "커뮤니티를 읍 등급으로 이끌어 주세요.",
};
