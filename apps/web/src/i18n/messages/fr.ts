...
export const fr: LocaleMessages = {
  ...
  "settings.highContrast": "Mode de contraste",
  "settings.reducedMotion": "Mouvement",
  "settings.keyboardNav": "Navigation au clavier",
  "settings.contrast.standard": "Standard",
  "settings.contrast.high": "Contraste eleve",
  "settings.contrast.colorblind_deuteranopia": "Deuteranopie (vert)",
  "settings.contrast.colorblind_protanopia": "Protanopie (rouge)",
  "settings.motion.none": "Mouvement complet",
  "settings.motion.reduce": "Mouvement reduit",
  "settings.motion.eliminate": "Pas de mouvement",
  "a11y.itemPickup": "{item} ramasse",
  "a11y.questUpdate": "Quete mise a jour : {quest}",
  "a11y.npcDialogue": "{npc} parle",
  "a11y.systemMessage": "Notification systeme",

  "housing.title": "Ma maison",
  "housing.enter": "Entrer dans la maison",
  "housing.exit": "Sortir de la maison",
  "housing.room.living_room": "Salon",
  "housing.room.bedroom": "Chambre",
  "housing.room.kitchen": "Cuisine",
  "housing.room.study": "Bureau",
  "housing.place": "Placer un meuble",
  "housing.remove": "Retirer un meuble",
  "housing.happiness": "Bonheur : {score}",
  "housing.unlock": "Debloquer la piece ({cost} pieces)",
  "housing.noDeed": "Il vous faut un acte de propriete",
  "housing.locked": "Cette piece est verrouillee",
  "item.house_deed": "Acte de propriete",
  "item.table": "Table",
  "item.chair": "Chaise",
  "item.bed": "Lit",
  "item.lamp": "Lampe",
  "item.bookshelf": "Bibliotheque",
  "item.rug": "Tapis",
  "item.painting": "Tableau",
  "item.plant_pot": "Pot de fleurs",
  "item.window_curtain": "Rideau",
  "achievement.homeowner.title": "Proprietaire",
  "achievement.homeowner.description": "Atteignez 50 de bonheur avec vos meubles.",

  "crafting.title": "Artisanat",
  "crafting.station.hand": "A la main",
  "crafting.station.workbench": "Etabli",
  "crafting.start": "Commencer la fabrication",
  "crafting.inProgress": "Fabrication en cours...",
  "crafting.done": "Fabrication terminee !",
  "crafting.failed": "Echec : materiaux manquants ou mauvaise station.",
  "crafting.needStation": "Un etabli est necessaire pour cette recette.",
  "recipe.iron_ingot": "Fondre un lingot de fer",
  "recipe.plank": "Couper une planche",
  "recipe.cloth": "Tisser du tissu",
  "recipe.workbench": "Construire un etabli",
  "recipe.stone_axe": "Fabriquer une hache en pierre",
  "recipe.iron_axe": "Forger une hache en fer",
  "recipe.stone_pickaxe": "Fabriquer une pioche en pierre",
  "recipe.iron_pickaxe": "Forger une pioche en fer",
  "item.iron_ingot": "Lingot de fer",
  "item.plank": "Planche",
  "item.cloth": "Tissu",
  "item.stone_axe": "Hache en pierre",
  "item.iron_axe": "Hache en fer",
  "item.stone_pickaxe": "Pioche en pierre",
  "item.iron_pickaxe": "Pioche en fer",
  "item.workbench": "Etabli",
  "achievement.first_craft.title": "Premiere creation",
  "achievement.first_craft.description": "Fabriquez votre premier objet a un atelier.",
  ...
  "friendship.title": "Amitie",
  "friendship.level.0": "Inconnu",
  "friendship.level.1": "Connaissance",
  "friendship.level.2": "Ami",
  "friendship.level.3": "Ami proche",
  "friendship.level.4": "Meilleur ami",
  "friendship.give": "Offrir un cadeau",
  "friendship.reaction.loved": "Adore!",
  "friendship.reaction.liked": "Content!",
  "friendship.reaction.neutral": "Merci pour le cadeau.",
  "friendship.reaction.disliked": "Pas vraiment son genre...",
  "friendship.levelUp": "Niveau d'amitie augmente!",
  "friendship.maxLevel": "Amitie maximale atteinte!",
  "friendship.dailyLimit": "Cadeau deja offert aujourd'hui.",
  "friendship.reward": "Recu {coins} pieces!",
  "item.gift_box": "Boite cadeau",
  "achievement.first_gift.title": "Premier cadeau",
  ...
  "mission.title": "Objectifs",
  "mission.daily": "Mission quotidienne",
  "mission.weekly": "Mission hebdomadaire",
  "mission.streak": "Serie: {days} jours",
  "mission.streakBonus": "Bonus de serie: x{multiplier}",
  "mission.complete": "Mission accomplie !",
  "mission.claim": "Reclamer la recompense",
  "mission.refresh": "Nouvelles missions disponibles !",
  "mission.progress": "{current} / {target}",
  "mission.daily_gather_wood.title": "Ramasser du bois",
  "mission.daily_gather_wood.description": "Ramassez 5 bois dans la foret.",
  "mission.daily_gather_stone.title": "Collecte de pierres",
  "mission.daily_gather_stone.description": "Ramassez 3 pierres dans les collines.",
  "mission.daily_fish.title": "Partie de peche",
  "mission.daily_fish.description": "Pechez 2 poissons dans un point d'eau.",
  "mission.daily_donate.title": "Aide au musee",
  "mission.daily_donate.description": "Faites don d'un objet au musee.",
  "mission.daily_cook.title": "Aide en cuisine",
  "mission.daily_cook.description": "Cuisinez 1 plat dans la cuisine.",
  "mission.daily_explore.title": "Vagabond",
  "mission.daily_explore.description": "Explorez 10 nouvelles cases de la carte.",
  "mission.daily_talk.title": "Papillon social",
  "mission.daily_talk.description": "Parlez a 2 PNJ differents.",
  "mission.daily_harvest_wheat.title": "Recolte de ble",
  "mission.daily_harvest_wheat.description": "Recoltez 3 bles dans votre ferme.",
  "mission.weekly_fish_master.title": "Maitre pecheur",
  "mission.weekly_fish_master.description": "Pechez 10 poissons cette semaine.",
  "mission.weekly_explorer.title": "Cartographe",
  "mission.weekly_explorer.description": "Explorez 50 cases de la carte cette semaine.",
  "mission.weekly_cook_feast.title": "Preparateur de festin",
  "mission.weekly_cook_feast.description": "Cuisinez 5 plats cette semaine.",
  "mission.weekly_social.title": "Mondain du village",
  "mission.weekly_social.description": "Parlez aux PNJ 8 fois cette semaine.",
  "achievement.first_mission.title": "Premiere mission",
  "achievement.first_mission.description": "Completez votre premiere mission.",
